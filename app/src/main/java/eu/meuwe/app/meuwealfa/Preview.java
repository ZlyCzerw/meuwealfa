...
/*  żeby odblokować, usuń w wierszach: 23 105 238 251
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        if (changed && getChildCount() > 0) {
            ...
            if (mPreviewSize != null) {
                /**
                 * As the calculation is done with the camera in landscape mode and then it is necessary to turn the camera
                 * so that it looks good, the changed values are passed.
                 */
/*
